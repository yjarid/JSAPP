...
export default class Search {
    // select DOM element & keep track of usefull data
    constructor() {
        this.injectHTML()
    ...
    // Events
    events() {
        this.closeIcon.addEventListener("click", this.closeOverlay.bind(this))
        this.headerSearchIcon.addEventListener("click", this.openOverlay.bind(this))
        this.inputField.addEventListener("keyup", this.keyPressHandler.bind(this))
    }
    ...
    sendRequest() {
        ...
        .then( (res) => {
            ...
            this.renderResultHTML(res.data)
        })
        .catch( () => {
            alert('jdjddjdj')
        })
    ...
    renderResultHTML(posts) {
      console.log(posts.length)
        if(posts.length) {
            ...
            this.resultArea.innerHTML = `<p class="alert alert-danger text-center shadow-sm">No result for that search</p>`
        }
